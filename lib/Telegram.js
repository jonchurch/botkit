        ...
        webserver.post('/telegram/receive', function(req, res) {
            ...
            if (telegram_message.message) {
                ...
                var message = {
                    ...
                    forward_from: telegram_message.message.forward_from,
                    forward_from_chat: telegram_message.message.forward_from_chat,
                    forward_date: telegram_message.message.forward_date,
                    reply_to_message: telegram_message.message.reply_to_message,
                    edit_date: telegram_message.messsage.edit_date,
                    entities: telegram_message.message.entities,
                    audio: telegram_message.message.audio,
                    document: telegram_message.message.document,
                    photo: telegram_message.message.photo,
                    sticker: telegram_message.message.sticker,
                    video: telegram_message.message.video,
                    voice: telegram_message.message.voice,
                    caption: telegram_message.message.caption,
                    contact: telegram_message.message.contact,
                    location: telegram_message.message.location,
                    venue: telegram_message.message.venue,
                };
