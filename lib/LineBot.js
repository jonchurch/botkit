...
function linebot(configuration) {
    ...
    line_botkit.middleware.normalize.use(function handleMessage(bot, message, next) {
        ...
        if (message.message) {
            ...
            message.sticker = message.message.type === 'sticker' ? {stickerId: message.message.stickerId, packageId: message.message.packageId} : null;
            message.image = message.message.type === 'image' ? message.message.id : null;
            message.video = message.message.type ==='video' ? message.message.id : null;
            message.audio = message.message.type === 'audio' ? message.message.id: null;
            message.file = message.message.type === 'file' ? { fileName: message.message.fileName, fileSize: message.message.fileSize} : null;
			message.location = message.type === 'location' ? { title: message.message.title, address: message.message.address, latitude: message.message.latitude, longitude: message.message.longitude } : null;
        }
